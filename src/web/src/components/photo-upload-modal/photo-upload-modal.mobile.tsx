...
export function PhotoUploadModalMobile({
  open,
  onOpenChange,
  stages,
  onUploadComplete,
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select value={selectedStageId} onValueChange={setSelectedStageId}>
              <SelectTrigger className={cn("h-12 text-base", errors.stage && 'border-destructive')}>
                <SelectValue placeholder="Select stage..." />
              </SelectTrigger>
              <SelectContent>
                {stages.map((stage) => (
                  <SelectItem key={stage.stageRunId} value={stage.stageRunId} className="py-3">
