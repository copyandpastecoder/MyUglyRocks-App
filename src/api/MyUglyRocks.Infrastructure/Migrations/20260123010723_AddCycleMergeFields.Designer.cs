...
namespace MyUglyRocks.Infrastructure.Migrations
{
    ...
    [Migration("20260123010723_AddCycleMergeFields")]
    partial class AddCycleMergeFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.BadWord", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("BadWordId"));
                    ...
                    b.ToTable("bad_words", (string)null);
                });
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.Cycle", b =>
                {
                    ...
                    b.Property<string>("MergedFromCycleIds")
                        .HasColumnType("text")
                        .HasColumnName("merged_from_cycle_ids");

                    b.Property<Guid?>("MergedIntoCycleId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.CycleSpecimen", b =>
                {
                    ...
                    b.Property<bool>("AddPhotosFromInventory")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.ErrorLog", b =>
                {
                    ...
                    b.Property<string>("HttpQueryString")
                        .HasColumnType("text")
                    ...
                    b.HasIndex("Severity", "DateCreated")
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.InvitationCode", b =>
                {
                    ...
                    b.HasIndex("IsRevoked", "DateExpires")
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.Tumbler", b =>
                {
                    ...
                    b.HasIndex("UserId", "Brand", "Model", "TumblerNumber")
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.Cycle", b =>
                {
                    b.HasOne("MyUglyRocks.Core.Entities.Cycle", "MergedIntoCycle")
                        .WithMany()
                        .HasForeignKey("MergedIntoCycleId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.InvitationCode", b =>
                {
                    ...
                    b.HasOne("MyUglyRocks.Core.Entities.User", "RevokedByUser")
                        .WithMany()
                        .HasForeignKey("RevokedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MyUglyRocks.Core.Entities.User", "UsedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyUglyRocks.Core.Entities.User", b =>
                {
                    b.HasOne("MyUglyRocks.Core.Entities.User", "InvitedByUser")
